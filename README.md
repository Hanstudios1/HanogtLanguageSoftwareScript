...
**HanogtLanguageSoftwareScript**, kullanıcıların tarayıcıda veya masaüstünde diledikleri gibi kod yazıp çalıştırabilecekleri, açık kaynaklı, modern ve güçlü bir IDE (Entegre Geliştirme Ortamı) projesidir.
...
```bash
git clone https://github.com/KULLANICI_ADINIZ/HanogtLanguageSoftwareScript.git
cd HanogtLanguageSoftwareScript
```
